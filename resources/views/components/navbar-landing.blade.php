...
<body>
    <div class="bg-gray-200 mx-auto px-10 py-5 flex items-center justify-between">
        ...
        <div class="flex space-x-3">
            @auth
            <span class="text-xl text-amber-500 hover:text-gray-500">{{auth()->user()->name}}</span>
            <a class="grid justify-center mx-auto size-10 rounded ring-1 ring-amber-500 hover:ring-gray-600/50 p-1 font-semibold" href="{{route('logout')}}">
                <svg width="30px" height="30px" viewBox="0 -0.5 25 25" stroke="#6b7280" stroke-width="0.5" xmlns="http://www.w3.org/2000/svg">
